    ...
    <!-- mid section -->
              <div class="row">
                ...
                <div class="col-lg-8 col-sm-12">
                    ...
                    <br><br>
                    <h1 class="text-center">Quote List</h1>
                    <br>
                    <hr>
                    ...
                    <div class="row">
                        <div class="img text-center col-lg-4 col-md-5">
                            <a href=""><img class="img-width-at-992" style="border-radius: 200px;width: 180px;height: 180px;" src="{{asset('../storage/'.$quote->photographer_profilepic)}}" alt=""></a>
                            <br><br>
                        </div>
                        <div class=" justify-items-at-768 justify-text-at-992 col-lg-8 col-md-7">
                            <h3 class="black"><span style="font-weight:none">New Quote From <span class="sky-blue">{{$quote->photographer_name}}</span></h3>
                            ...
                            <div style="float:right;" class=" justify-text-at-992">
                            <form enctype="multipart/form-data" method="POST" action="{{ route('deletequote') }}" enctype="multipart/form-data">
                                @csrf
                            <button style="width:150px;margin-right:3px;" class="mt-2 btn btn-danger" type="submit" >Delete Quote</button></form>
                            <form enctype="multipart/form-data" method="POST" action="{{ route('acceptquote') }}" enctype="multipart/form-data">
                                @csrf
                            <button style="width:150px;" class="mt-2 btn btn-primary" type="submit" style="border-radius: 20px;">Accept Quote</button></form>
